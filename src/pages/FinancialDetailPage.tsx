/**
 * Financial Detail Page Component
...
import { financialDetailContent } from '../data/demoContent';
...
const FinancialDetailPage: React.FC = () => {
  ...
  const [sections] = useState(financialDetailContent.sections);
  ...
  const handleBlockPress = useCallback((block: ContentBlock) => {
    ...
    // Navigate to sub-pages for detailed financial management
    if (block.id === 'recent-transactions') {
      navigate('/financial/transactions', { 
        breadcrumb: { label: 'Transactions', route: '/financial/transactions', id: 'transactions' }
      });
    }
  }, [navigate]);
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerSubtitle}>Detailed financial operations and reporting</Text>
        </View>
