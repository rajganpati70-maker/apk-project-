...
const PropertyDetailPage: React.FC = () => {
  ...
  const handleBlockPress = useCallback((block: ContentBlock) => {
    console.log('Property block pressed:', block.id);
    // Navigate to sub-pages for detailed property management
    if (block.id === 'property-tasks') {
      navigate('/properties/tasks', { 
        breadcrumb: { label: 'Property Tasks', route: '/properties/tasks', id: 'tasks' }
      });
    }
  }, [navigate]);
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerSubtitle}>Detailed property operations and management</Text>
        </View>
