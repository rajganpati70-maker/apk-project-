/**
 * Maintenance Detail Page Component
...
import { maintenanceDetailContent } from '../data/demoContent';
...
const MaintenanceDetailPage: React.FC = () => {
  ...
  const [sections] = useState(maintenanceDetailContent.sections);
  ...
  const handleBlockPress = useCallback((block: ContentBlock) => {
    ...
    // Navigate to sub-pages for detailed maintenance
    if (block.id === 'maintenance-requests') {
      navigate('/maintenance/requests', { 
        breadcrumb: { label: 'Requests', route: '/maintenance/requests', id: 'requests' }
      });
    }
  }, [navigate]);
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerSubtitle}>Detailed maintenance operations and tracking</Text>
        </View>
